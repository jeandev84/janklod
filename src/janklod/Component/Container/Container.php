...
class Container implements \ArrayAccess, ContainerInterface
{
    ...
    */
     ...
     * @return Container
    */
    public function facade(Facade $facade)
    {
        $this->facades[] = $facade;
    ...
    */
     ...
     * @throws Exception
    */
    public function callAction(string $abstract, string $method, array $params = [])
    {
        ...
        $implements = class_implements($objectClass);

        if(isset($implements[UsableContainer::class]))
        {
            if(method_exists($objectClass, "setContainer"))
            {
                $objectClass->setContainer($this);
            }
        }
